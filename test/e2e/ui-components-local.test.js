...
System.register(
  ...
  [
    ...
    "rx-extra/add/operator/throughNodeStream",
    "rxjs/Subject"
  ],
        ...
        BridgeDb = (function() {
          function BridgeDb(config) {
            ...
            this.dataSourceProperties = function(input) {
              var bridgeDb = _this;
              return bridgeDb.dataSourceMappings$.map(function(mapping) {
                return mapping[input];
              });
            };
            this.parseXrefRow = function(_a) {
              var identifier = _a[0],
                conventionalName = _a[1],
                symbol = _a[2];
              var bridgeDb = _this;
              ...
              return bridgeDb.dataSourceMappings$
                .map(function(mapping) {
                  return mapping[conventionalName];
                })
            ...
            this.xrefsBatch = function(
              ...
              var bridgeDb = _this;
              var dataSourceFilterParamSection = dataSourceFilter
                ? "?dataSource=" + dataSourceFilter
                : "";
              var conventionalNames = lodash_1.isArray(conventionalNameOrNames)
                ? conventionalNameOrNames
                : lodash_1.fill(
                    new Array(identifiers.length),
                    conventionalNameOrNames
                  );
              var body = lodash_1
                .zip(identifiers, conventionalNames)
                .map(function(x) {
                  return x.join("\t");
                })
                .join("\n");
            ...
            var debounceSignal = xrefsRequestQueue.debounceTime(
              XREF_REQUEST_DEBOUNCE_TIME
            );
            bridgeDb.xrefsResponseQueue = xrefsRequestQueue
              ...
              .mergeMap(function(inputs) {
                ...
                var conventionalNames = inputs.map(function(input) {
                  return input.conventionalName;
                });
                var identifiers = inputs.map(function(input) {
            ...
            var getTSV = (bridgeDb.getTSV = function(url, method, body) {
              ...
              return Observable_1.Observable.ajax(ajaxRequest)
                .map(function(ajaxResponse) {
                  return ajaxResponse.xhr.response;
                })
            ...
            bridgeDb.dataSourceMappings$ = Observable_1.Observable.forkJoin(
              ...
              .mergeMap(function(results) {
                ...
                return Observable_1.Observable.from(rows).map(function(fields) {
                  return fields.reduce(function(acc, field, i) {
                    ...
                    acc[metadata.term] = parseAsDatatype[
                      metadata[RDF + "datatype"]
                    ](field);
                    return acc;
                  }, {});
                });
              ...
              .map(function(dataSource) {
                ...
                if (!!primaryUriPattern) {
                  var regexIdentifierPattern =
                    dataSource.hasRegexPattern || ".*";
                  ...
                  if (
                    primaryUriPattern.indexOf("$id") ===
                    indexOfDollaridWhenAtEnd
                  ) {
                    dataSource.sameAs = dataSource.sameAs || [];
          ...
          BridgeDb.prototype.attributes = function(
            organism,
            conventionalName,
            identifier
          ) {
          ...
          BridgeDb.prototype.attributeSearch = function(
            organism,
            query,
            attrName
          ) {
          ...
          BridgeDb.prototype.isFreeSearchSupported = function(organism) {
            ...
            var ajaxRequest = {
              url:
                bridgeDb.config.baseIri + organism + "/isFreeSearchSupported",
              method: "GET",
              responseType: "text",
          ...
          BridgeDb.prototype.isMappingSupported = function(
            organism,
          ...
          BridgeDb.prototype.xrefExists = function(
            organism,
            conventionalName,
            identifier
          ) {
          ...
          BridgeDb.prototype.xrefs = function(
            organism,
            conventionalName,
            identifier,
            dataSourceFilter
            ...
            return xrefsResponseQueue
              ...
              .find(function(xrefBatchEnvelope) {
                return Observable_1.Observable.zip(
                  bridgeDb.dataSourceMappings$.map(function(mapping) {
                    return mapping[
                      xrefBatchEnvelope.inputDataSource
                    ].conventionalName;
                  }),
                  bridgeDb.dataSourceMappings$.map(function(mapping) {
                    return mapping[conventionalName].conventionalName;
                  }),
                  function(
              ...
              .mergeMap(function(x) {
                return Observable_1.Observable.from(x.xrefs);
              });
          };
          return BridgeDb;
        })();
...
System.register(
  "src/ui/XrefsAnnotationPanel",
  [
    "lodash",
    "src/main",
    "react",
    "./stripped-bootstrap.css",
  ...
  function(exports_2, context_2) {
    ...
    function getLinkout(entityReference) {
      ...
      if (urlPattern) {
        ...
        return lodash_2
          .compact(
            lodash_2.concat([entityReference.about], entityReference.sameAs)
          )
          .filter(function(uri) {
      ...
      execute: function() {
        ...
        XrefsAnnotationPanel = (function(_super) {
          ...
          XrefsAnnotationPanel.prototype.updateXrefs = function() {
            ...
            var xrefsRequest = (that.xrefsRequest = bridgedb.xrefs(
              props.organism,
              props.dataSource,
              props.identifier
            ));
            xrefsRequest
              ...
              .map(function(listItems) {
                ...
                if (listItemsCount <= 1) {
                  ...
                  return convertEntityReferenceToListItems(
                ...
                var sortedListItems = lodash_2
                  .toPairs(lodash_2.groupBy(listItems, "key"))
                ...
                var primaryListItem = lodash_2.remove(sortedListItems, function(
                  element
                ) {
                  return element.key === primaryDataSource;
                })[0];
                var primaryXRefId = lodash_2.remove(
                  primaryListItem.values,
                  function(element) {
                ...
                return sortedListItems.map(function(formattedListItem) {
                  return {
                    ...
                    values: formattedListItem.values.map(function(v) {
                      return lodash_2.pick(v, ["text", "uri"]);
                    })
                  };
                });
              })
              .do(
                ...
                function(err) {
                  ...
                  console.error(err);
                  var xrefs = convertEntityReferenceToListItems(
                    primaryEntityReference
                  );
                  that.setState({
                    xrefs: addWikiPathwaysSearch(primaryEntityReference, xrefs)
          ...
          XrefsAnnotationPanel.prototype.componentDidUpdate = function(
            prevProps,
            prevState
          ) {
            var that = this;
            ...
            if (
              ...
              prevProps.identifier !== props.identifier
            ) {
              that.updateXrefs();
            }
          };
          ...
          XrefsAnnotationPanel.prototype.render = function() {
            ...
            return React.createElement(
              "div",
              { style: props.style, className: "annotation ui-draggable" },
              React.createElement(
                "header",
                null,
                React.createElement(
                  "span",
                  {
                    className: "annotation-header-close",
                ...
                React.createElement(
                  "span",
                  { className: "annotation-header-text" },
                  props.displayName
                ),
                React.createElement(
                  "div",
              ...
              React.createElement(
                "div",
                { className: "annotation-items-container" },
                React.createElement(
                  "ul",
                  { className: "annotation-items-container-list" },
                  xrefs.map(function(xref) {
                    ...
                    return React.createElement(
                      ...
                      React.createElement(
                        "span",
                        { className: "annotation-item-title" },
                        xref.key + ": "
                      ),
                      values.map(function(v, i) {
                        ...
                        return React.createElement(
                          "span",
                          { key: text, className: "annotation-item-text" },
                          uri
                            ? React.createElement(
                                "a",
...
System.register(
  "test/e2e/ui-components-local.test",
  ["react", "react-dom", "lodash", "src/ui/XrefsAnnotationPanel"],
  function(exports_3, context_3) {
    ...
    return {
      ...
      execute: function() {
        ...
        Demo = (function(_super) {
          ...
          Demo.prototype.render = function() {
            ...
            return React.createElement(
              ...
              lodash_3.values(that.state.entities).map(function(entity) {
                return React.createElement(
                  "button",
                  { key: entity.id, id: entity.id },
                  entity.displayName
                );
              }),
              !selected
                ...
                : React.createElement(
                    ...
                    null,
                    React.createElement(
                      XrefsAnnotationPanel_1.XrefsAnnotationPanel,
                      {
        ...
        entities = {
          "123": {
            ...
            entityReference: {
              name: "Formaldehyde",
              displayName: "formaldehyde",
              type: ["Metabolite", "biopax:SmallMoleculeReference"],
              isDataItemIn: {
          ...
          "124": {
            ...
            entityReference: {
              ...
              displayName: "CCR5",
              type: ["GeneProduct", "biopax:DnaReference"],
              isDataItemIn: {
        ...
        ReactDOM.render(
          React.createElement(Demo, { entities: entities }),
          container
        );
      }
    };
