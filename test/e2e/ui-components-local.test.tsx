...
import { XrefsAnnotationPanel } from "../../src/components/XrefsAnnotationPanel";
...
class Demo extends React.Component<any, any> {
  ...
  render() {
    ...
    return (
      <div onClick={that.handleClick.bind(that)}>
        {values(that.state.entities).map((entity: entity) => (
          <button key={entity.id} id={entity.id}>
            {entity.displayName}
          </button>
        ))}
        {!selected ? (
...
ReactDOM.render(<Demo entities={entities} />, container);
