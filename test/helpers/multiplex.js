...
module.exports = function(options) {
  ...
  var top = blessed.box({
    ...
    height: headerHeight,
    content:
      '"q" to quit w/out saving. Up/Down keys to scroll.' + headerContent,
    tags: true,
    border: {
      type: "line"
    },
  ...
  var leftHeight = options.left.height || "100%-" + String(headerHeight);
  ...
  var rightHeight = options.right.height || "100%-" + String(headerHeight);
  ...
  contentBoxes.forEach(function(box) {
    ...
    var scrollDriverSource = Rx.Observable.fromEvent(box, "scroll", function(
      data
    ) {
      return data;
    })
  ...
  return Rx.Observable.amb(saveSource, nextSource).doOnNext(function(
    userResponseOnFailure
  ) {
