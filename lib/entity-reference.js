...
var EntityReference = function(instance) {
  ...
  /**
   * EntityReference See {@link http://www.biopax.org/release/biopax-level3.owl#EntityReference|biopax:EntityReference}
   ...
   * @property {Object} inDataset The dataset (database) for the identifier.
   * @property {String} inDataset.preferredPrefix See {@link http://identifiers.org/idot/preferredPrefix|idot:preferredPrefix}
   * @property {Array<String>} inDataset.alternatePrefix See {@link http://identifiers.org/idot/alternatePrefix|idot:alternatePrefix}
   ...
   * @property {String} @type Biological type. See {@link http://www.w3.org/TR/json-ld/#dfn-node-type|JSON-LD documentation}
  */
   ...
   * @param {Object} entityReference.inDataset The dataset (database) for the identifier.
