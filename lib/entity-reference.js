...
//  };
  ...
  var enrich = function(input, options) {
    ...
    return inputSource
      ...
      .flatMap(function(entityReference) {
        console.log('entityReference269');
        console.log(entityReference);
        // TODO need to get organism working
      ...
      .map(function(entityReference) {
        console.log('entityReference285');
        console.log(entityReference);
  ...
  function exists(systemCode, identifier, organism) {
    ...
    .flatMap(function(organismName) {
      ...
      var sourceUrl = instance.config.baseIri + path;
  ...
  function _expand(entityReference) {
    ...
    _(iriParserPairs).map(function(iriParserPair) {
      ...
      if (!_.isEmpty(iri)) {
        _.defaultsDeep(entityReference, iriParserPair[1](iri));
      }
    });
  ...
  function freeSearch(args) {
    ...
    .doOnError(function(err) {
      console.error('Error in bridgedb.entityReference.freeSearch()');
      throw err;
    })
    .map(function(array) {
      return {
