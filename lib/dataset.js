      ...
      .map(function(dataset) {
        if (!!dataset._bridgeDbType) {
          ...
          if (dataset._bridgeDbType === 'gene' ||
            ...
            dataset.subject.push('gpml:GeneProductReference');
