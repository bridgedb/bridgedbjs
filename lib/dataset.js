...
var Dataset = function(instance) {
   ...
   * @property {JsonldType} @type Biological type, as used in GPML at WikiPathways and in PathVisio-Java
   *                                                       (see {@link http://vocabularies.wikipathways.org/gpml#Type|gpml:Type}).
   *                                                       Also the biological type as used in Biopax (see the domain for
