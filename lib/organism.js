...
var Organism = function(instance) {
   ...
   * @property {Iri} @id Preferred IRI for identifying an organism, using http://identifiers.org/taxonomy/.
   * @property {Object[]} name
   * @property {String} name.en English name, when available.
   * @property {String} name.la Full Latin name.
   */
  ...
  function _getByEntityReference(entityReference) {
    ...
    var bridgeDbSystemCodeExists = !!entityReference.isDataItemIn &&
   ...
   * @return {Stream<Organism>} Normalized organism name. Note that if args.normalize is set to false,
