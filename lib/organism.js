...
var Organism = function(instance) {
   ...
   */
  var getAll = function() {
    return Utils._runOnce('organisms',
  ...
  function normalize(organism) {
    ...
    var normalizedOrganismIdentifier =
      Utils._normalizeText(organismIdentifier);
    return getAll().find(function(organism) {
      ...
      return Utils._normalizeText(latinName) ===
        normalizedOrganismIdentifier ||
        Utils._normalizeText(latinNameAbbreviated) ===
          normalizedOrganismIdentifier ||
        Utils._normalizeText(englishName) === normalizedOrganismIdentifier;
    })
    .head();
  }
  ...
  function setInstanceOrganismName(organismLatinName) {
    instance.organismLatinName = organismLatinName;
  }
