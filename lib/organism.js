...
//  };
  ...
  function get(searchCriteria) {
    ...
    return query(searchCriteria).first();
  }
  ...
  var _getBySystemCodeAndIdentifier =
    ...
    .flatMap(function(organism) {
      return instance.entityReference.exists(
          systemCode, identifier, organism.nameLanguageMap.la)
  ...
  function _getInstanceOrganism(searchCriteria) {
    ...
    console.log('searchCriteriaUsed');
    console.log(searchCriteriaUsed);
