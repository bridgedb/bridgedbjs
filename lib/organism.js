...
var Organism = function(instance) {
   ...
   * @return {string} organisms.organism.la Unabbreviated Latin name.
   */
  var getAll = function() {
   ...
   * @return {Stream<string>} organism Unabbreviated Latin name.
   * @return {string}
   */
  ...
  /**
   * Normalize organism specified by user.
   *
   ...
   *
   * @param {string} organismLatinName Organism name. See method getLatinName for acceptable inputs.
   */
