...
var Organism = function(instance) {
   ...
   *      or abbreviated like "E. coli") or English. In the future, we might include
   *      IRIs for organisms.
   * @return {Stream<Organism>} organismStream
   */
  function _normalize(organism) {
    ...
    var normalizedOrganismIdentifier =
      normalizeText(organismIdentifier);
    ...
    .filter(function(organism) {
      ...
      return normalizeText(latinName) ===
        normalizedOrganismIdentifier ||
        normalizeText(latinNameAbbreviated) ===
          normalizedOrganismIdentifier ||
