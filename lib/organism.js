...
var Organism = function(instance) {
  ...
  var getByIdentifier = function(identifier, callback) {
    ...
    var getByIdentifierWithCallback1 = highland.curry(getByIdentifierWithCallback, identifier);
    return Utilities.runOncePerInstance(instance, 'myorganism', organismLoadedStream, highland.wrapCallback(getByIdentifierWithCallback1)).each(function(organism) {
