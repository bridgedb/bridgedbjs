...
var Organism = (function(){
  ...
  var getAvailable = function() {
    ...
    console.log(this);
    var resultFromRunOnce = Utilities.runOnce(this, 'availableOrganisms', organismsAvailableLoadedStream);
    console.log('resultFromRunOnce');
    console.log(resultFromRunOnce);
    console.log('getAvailable organisms');
    if (!!resultFromRunOnce) {
      return resultFromRunOnce;
    }
    /*
    if (!!this.availableOrganisms) {
      //return callback(null, availableOrganisms);
      console.log('returning preloaded list of available organisms');
      return highland([this.availableOrganisms]);
    } else if (this.availableOrganismsLoading) {
      console.log('waiting for list of available organisms');
      return organismsAvailableLoadedStream;
    }
    //*/

    console.log('getting list of available organisms');
    this.availableOrganismsLoading = true;
