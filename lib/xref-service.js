...
var XrefService = function(instance) {
   ...
   * get
   *
   * @param {object|string} specifiedEntityReference
   * @param {object} [options]
   * @return
   */
  function get(specifiedEntityReference, options) {
    options = options || {};
    // normalize the provided entity reference
    return instance.entityReferenceService.get(specifiedEntityReference)
    ...
    .map(function(normalizedEntityReference) {
      ...
      var path = '/' + encodeURIComponent(specifiedEntityReference.organism) + '/xrefs/' + encodeURIComponent(specifiedEntityReference.bridgedbSystemCode) + '/' + encodeURIComponent(specifiedEntityReference.identifier);
  ...
  function formatAllForDisplay(args) {
    var entityReferenceStream = args.entityReferenceStream;
