...
var EntityReferenceService = function(instance) {
   ...
   *
   * @return {stream} entityReferenceStream - will have one object, as described below
   *         {object} entityReference - enriched with databases metadata and organism
   */
  function get(args) {
   ...
   * @param {string|object} args.sourceEntityReference - See "get" method for what constitutes a usable entityReference
   * @return {array} entityReferences - one or more entity references with the target preferredPrefix.
   */
  function map(args) {
