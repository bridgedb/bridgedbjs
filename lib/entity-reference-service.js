...
var EntityReference = function(instance) {
  ...
  function searchByName(args) {
    ...
    .map(function(normalizedOrganism) {
      //http://webservice.bridgedb.org/Mouse/attributeSearch/Nfkb1
      var path = '/' + encodeURIComponent(normalizedOrganism) + '/attributeSearch/' + encodeURIComponent(name);
      ...
      return highland('end', tsvStream).each(function() {
