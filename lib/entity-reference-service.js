...
var EntityReference = function(instance) {
  ...
  function searchByAttribute(args) {
    ...
    .flatMap(function(normalizedOrganism) {
      ...
      /*
      .concat(function(searchResult) {
        console.log('936searchResult');
        console.log(searchResult);
        return highland([instance.metadataService.getByDb(searchResult.db)]).flatMap(function(metadataRow) {
      ...
      .concat(instance.metadataService.getByDb)
      .flatten();
