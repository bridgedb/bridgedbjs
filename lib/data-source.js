...
var DataSource = function(instance) {
  ...
  function find(args) {
    ...
    var alternateFilters =  [
      function(providedDataSet, referenceDataSet) {
        console.log('providedDataSet.exampleIdentifier');
        console.log(providedDataSet.exampleIdentifier);
        console.log('referenceDataSet.identifierPattern');
        console.log(referenceDataSet.identifierPattern);
        return !!providedDataSet.exampleIdentifier &&
          !!referenceDataSet.identifierPattern &&
          referenceDataSet.isPrimary &&
          referenceDataSet.identifierPattern.test(
              providedDataSet.exampleIdentifier);
      }
    ];

    return getAllNew().collect()
