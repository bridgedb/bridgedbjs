...
function BridgeDbUI(args) {
  ...
  if (selectedDataset$.onNext) {
    ...
    .doOnNext(function(value) {
      console.log('value207 ');
      console.log(value);
    })
    .concatMap(function(selectedDatasetId) {
      return primaryDatasetList$.map(function(candidateDatasets) {
    ...
    .doOnNext(function(selectedDataset) {
      ...
      selectedDataset$.onNext(selectedDataset);
    })
    //.startWith({})
    .subscribe(function(result) {
      console.log('result248');
      console.log(result);
    }, function(err) {
      console.log('err251');
      console.log(err);
...
//      var candidateDatasets = results[0];
//      var selectedDataset = results[1];
//
//      console.log('candidateDatasets.length: ' + candidateDatasets.length);
//      //console.log(candidateDatasets);
//      console.log('typeof selectedDataset242: ' + typeof selectedDataset);
//      console.log(selectedDataset);
//
//      return candidateDatasets
//      .map(function(candidateDataset) {
//        console.log('typeof candidateDataset: ' + typeof candidateDataset);
...
//          selected: (!!candidateDatasetId && (candidateDatasetId === selectedDataset.id))
...
//    .withLatestFrom(selectedDataset$)
//    .map(function(result) {
//      var candidateDatasets = result[0];
//      var selectedDataset = result[1];
//      console.log('candidateDatasets.length: ' + candidateDatasets.length);
//      return candidateDatasets
//      .map(function(candidateDataset) {
