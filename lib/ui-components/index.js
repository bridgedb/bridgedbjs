...
function BridgeDbUIElement(args) {
  ...
  return h('nav', {
          'className': 'bridgedb kaavio-editor-annotation navbar navbar-default navbar-form well well-sm',
        },
        h('div', {
            ...
            h(EntityReferenceSearch, {
              ...
              onChange: function(entityReference) {
                ...
                // NOTE: AP requested that selection via entity reference search NOT change the value
                // of the entity type
                latestEntity$
                .first()
