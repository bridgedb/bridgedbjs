...
function DatasetControl(args) {
  ...
  var selectedDataset$ = Rx.Observable.merge(
      props.dataset || Rx.Observable.return(datasetPlaceholder),
      handleChange
  ...
  return h('select', {
    ...
    Rx.Observable.merge(
        ...
        .concatMap(function(result) {
          ...
          .map(function(currentDatasetList) {
            return [
              currentDatasetList,
              selectedDataset,
            ];
    ...
    .map(function(result) {
      ...
      .map(function(candidateDataset) {
        ...
        return h('option', {
          ...
          selected: (candidateDatasetId === selectedDataset.id)
