...
var JsonldMatcher = (function() {
  ...
  function _find(args, dataStream, name, selectedKeys, alternateFilters) {
    ...
    .flatMap(function(dataSet) {
      var alternateFilterWithReferenceDataSet =
        highland.curry(alternateFilters[0], dataSet);
      return highland([
        ...
        highland(dataSet).filter(alternateFilterWithReferenceDataSet)
        ...
        //*
        highland([{values: ['weeeeweeee1', 'weeeeweeee2', 'weeeeweeee3']}])
        .append(highland.nil),
        //*/
