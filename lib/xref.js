  ...
  function get(input, options) {
    ...
    var fullEntityReferenceSource = Rx.Observable.catch(
        ...
        .doOnError(function(err) {
          err.message = (err.message || '') + ' in BridgeDb.Xref.get after XHR request';
          console.error(err.stack);
        })
        .streamThrough(csv(csvOptions))
        .doOnError(function(err) {
          err.message = (err.message || '') + ' in BridgeDb.Xref.get after csv parsing';
          console.error(err.stack);
        })
        .map(function(array) {
          var result = {};
        ...
        .doOnError(function(err) {
          err.message = (err.message || '') + ' in BridgeDb.Xref.get after adding context';
          console.error(err.stack);
        }),
        Rx.Observable.throw(
