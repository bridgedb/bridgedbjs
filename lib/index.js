 ...
 * @param {string} [options.baseIri='http://pointer.ucsf.edu/d3/r/data-sources/bridgedb.php/'] Base IRI (URL) for your BridgeDb
 ...
 *                It should be 'http://webservice.bridgedb.org/'
 *                but we are using a proxy for now for CORS.
 * @param {string} [options.datasetsMetadataIri='http://pointer.ucsf.edu/d3/r/data-sources/bridgedb-datasources.php'] Location
