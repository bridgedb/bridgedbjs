...
var BridgeDb = (function(){
  ...
  function getBridgedbDatabaseMetadataForIdentifiersNamespace(identifiersNamespace, callback) {
    async.waterfall([
      function(waterfallCallback) {
        getBridgedbDatabaseMetadata(function(err, bridgedbDatabaseMetadata) {
          console.log('getBridgedbDatabaseMetadataForIdentifiersNamespace');
          waterfallCallback(null, bridgedbDatabaseMetadata);
        });
      },
      function(bridgedbDatabaseMetadata, waterfallCallback) {
  ...
  function getBridgedbDatabaseMetadataForDbName(dbName, callback) {
    async.waterfall([
      function(waterfallCallback) {
        getBridgedbDatabaseMetadata(function(err, bridgedbDatabaseMetadata) {
          console.log('getBridgedbDatabaseMetadataForDbName');
          waterfallCallback(null, bridgedbDatabaseMetadata);
        });
      },
      function(bridgedbDatabaseMetadata, waterfallCallback) {
